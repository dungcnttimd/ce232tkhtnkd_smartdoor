...
<section id="home">
        ...
        <li><a onClick={switchDashboard}>Profile</a></li>
        <li><a onClick={switchControl}>Control</a></li>
        <li><a onClick={switchAddMember}>Add</a></li>
        <li><a onClick={switchStream}>Streaming</a></li>  
        <li><a onClick={logOut}>Log Out</a></li>
				...
				<div class="container">
					<h1><span class="logo"></span><small></small></h1>
